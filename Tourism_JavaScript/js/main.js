document.addEventListener("DOMContentLoaded", function() {
  ...
  myForm.addEventListener("submit", function(e) {
    ...
    //console.log(hotel.options[hotel.selectedIndex].textContent);
  ...
  function displayBill() {
    ...
    var data =
      ...
      nbPerson +
      " person, a " +
      hotelIndex.options[hotelIndex.selectedIndex].text +
      " Hotel in " +
      nbDays +
      " days .\n Extras: " +
      extOptionTxt +
  ...
  function calculateBill() {
    ...
    var subTotal = parseFloat(hotel * room * nbDays + x).toFixed(2);
